        ...
        <div class="row">
          ...
          <main role="main" class="col-md-9 ml-sm-auto col-lg-10">
            <div>
              <h3>My Feedback</h3>
              <ul class="list-group">
                <li v-for="(blog, index) in blogs" :key="index" class="list-group-item">
      ...
      meta: [
        {
          hid: "description",
          name: "description",
          content: "View and manage your feedback in the user dashboard. You can browse your submitted feedback and edit or update it.",
        },
      ],
    };
  },
