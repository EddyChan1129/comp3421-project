            ...
            <div>
              ...
              <ul class="list-group">
                <li v-for="(order, index) in orders" :key="index" class="list-group-item">
                  <nuxt-link v-for="(product, index2) in order.product" :key="index2"
      ...
      meta: [
        {
          hid: "description",
          name: "description",
          content: "View and manage all your orders on our website. You can view order details, track order progress, and manage order-related products.",
        },
      ],
    };
  },
